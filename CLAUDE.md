...
**tRPC API Layer**: Type-safe end-to-end API with modular routers (apiChat, ptyChat, file, projectFolder, event, userSettings, model) and real-time capabilities via subscriptions.

**Repository Pattern**: Consistent data access layer with dual persistence strategies - SQLite database (via Kysely and better-sqlite3) for chat sessions, and file-based JSON for settings.
