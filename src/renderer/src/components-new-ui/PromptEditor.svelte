...
>
  ...
  <div class="relative flex flex-1 flex-col">
    <textarea
      ...
      class="scrollbar-thin placeholder-muted h-full w-full flex-1 resize-none border-none bg-transparent p-4 text-[14px] leading-6 outline-none placeholder:text-sm"
    ></textarea>
